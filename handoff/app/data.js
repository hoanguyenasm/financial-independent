/* ============================================================
   ...
   Attaches: window.{DATA, FX, FMT, FIRE}
   ============================================================ */
(function () {
  ...
  const CATEGORIES = [
    ...
    { id: 'supermarket', name: 'Supermarket', kind: 'expense', group: 'Food', color: '#7CCB4E' },
    { id: 'restaurant', name: 'Restaurant', kind: 'expense', group: 'Food', color: '#FB923C' },
    ...
    { id: 'healthcare', name: 'Healthcare', kind: 'expense', group: 'Healthcare', color: '#34D399' },
    ...
    { id: 'abo', name: 'Subscriptions', kind: 'expense', group: 'Lifestyle', color: '#818CF8' },
  ...
  const GROUP_DEFS = [
    ...
    { group: 'Lifestyle', color: '#F472B6', subs: [['travel', 1198], ['shopping', 500], ['abo', 64]] },
    { group: 'Unterhalt', color: '#E8A33D', subs: [['unterhalt', 1272]] },
    { group: 'Food', color: '#7CCB4E', subs: [['supermarket', 640], ['restaurant', 380]] },
    { group: 'Healthcare', color: '#34D399', subs: [['ivf', 326], ['healthcare', 180], ['fitness', 78]] },
  ...
  const T = [
    ...
    ['REWE', 'supermarket', 'EUR', 'amex', 'you', [24, 96]],
    ['EDEKA', 'supermarket', 'EUR', 'amex', 'partner', [18, 88]],
    ['ALDI SÜD', 'supermarket', 'EUR', 'comdirect', 'you', [12, 64]],
    ['Lidl', 'supermarket', 'EUR', 'comdirect', 'partner', [15, 72]],
    ['dm-drogerie markt', 'healthcare', 'EUR', 'amex', 'partner', [9, 58]],
    ['L\'Osteria', 'restaurant', 'EUR', 'amex', 'you', [38, 96]],
    ['Vapiano', 'restaurant', 'EUR', 'revolut', 'partner', [22, 64]],
    ['Starbucks', 'restaurant', 'EUR', 'amex', 'you', [4.8, 12.5]],
    ['Lieferando', 'restaurant', 'EUR', 'amex', 'partner', [18, 52]],
    ['Deutsche Bahn — ICE', 'travel', 'EUR', 'comdirect', 'you', [39, 158]],
    ['Aral Tankstelle', 'travel', 'EUR', 'amex', 'you', [62, 98]],
    ...
    ['Netflix', 'abo', 'EUR', 'revolut', 'you', [17.99, 17.99]],
    ['Spotify Family', 'abo', 'EUR', 'revolut', 'partner', [17.99, 17.99]],
    ['iCloud+ 2TB', 'abo', 'EUR', 'amex', 'you', [9.99, 9.99]],
    ['ChatGPT Plus', 'abo', 'USD', 'amex', 'you', [20, 20]],
    ...
    ['Apotheke', 'healthcare', 'EUR', 'amex', 'partner', [12, 64]],
  ...
  const RULES = [
    { id: 1, match: 'REWE SAGT DANKE', cat: 'supermarket', hits: 63 },
    { id: 2, match: 'DEUTSCHE BAHN', cat: 'travel', hits: 41 },
    { id: 3, match: 'TELEKOM DEUTSCHLAND', cat: 'telecom', hits: 14 },
    { id: 4, match: 'NETFLIX.COM', cat: 'abo', hits: 12 },
  ...
  window.FX = { rate: FXRATE, sym: SYM, base: 'EUR' };
  window.FMT = { eur, usd, vnd, orig, toBase, display, displayCompact: compactCur, compactCur, catName, catColor, fmtDay, fmtMonthYear, MONTHS };
  window.FIRE = { monthsToFI, fiDate };
  window.DATA = {
